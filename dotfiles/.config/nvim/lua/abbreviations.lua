...
local corrections = {
  ...
  ["abysmal{,ly}"] = "abismal{,ly}",
  ["academic"] = "acadmic",
  ["accelerat{e,es,ed,ing,ion,ions}"] = "acelerat{e,es,ed,ing,ion,ions}",
  ["accept"] = "acecpt",
  ["accept{able,ably}"] = "accept{ible,ibly}",
  ["accessor{y,ies}"] = "acessor{y,ies}",
  ["access{ible,ibly,ibility}"] = "acess{ible,ibly,ibility}",
  ...
  ["acknowledg{e,es,ed,ing,ement,ements}"] = "acknowleg{e,es,ed,ing,ement,ements}",
  ["acquaintance"] = "{acquaintence,aquaintance}",
  ["acquir{e,es,ed,ing}"] = "aquir{e,es,ed,ing}",
  ...
  ["annual"] = "anual",
  ["anonymous{,ly}"] = "anonymus{,ly}",
  ["another"] = "anohter",
  ["answer"] = "anwser",
  ["anticipat{e,es,ed,ing,ion,ions}"] = "anticiapt{e,es,ed,ing,ion,ions}",
  ...
  ["atheist{}"] = "athiest{,s}",
  ["athlet{ic,ics,ically}"] = "athelet{ic,ics,ically}",
  ["attendance{}"] = "attendence{,s}",
  ["attention{}"] = "attension{,s}",
  ["attribut{e,es,ed,ing}"] = "attrubut{e,es,ed,ing}",
  ["audience{}"] = "audiance{,s}",
  ["author"] = "auhtor",
  ...
  ["better"] = "betetr",
  ["between"] = "betwen",
  ["bizarre{,ly}"] = "bizzare{,ly}",
  ["boolean{}"] = "boolen{,s}",
  ["both"] = "btoh",
  ["boundar{y,ies}"] = "boundr{y,ies}",
  ["branch{,es}"] = "brnach{,es}",
  ["brief{}"] = "breif{,s,ly}",
  ["bring{,s,ing}"] = "birng{,s,ing}",
  ["broccoli"] = "brocoli",
  ...
  ["capabilit{y,ies}"] = "capabilt{y,ies}",
  ["caribbean"] = "carribean",
  ...
  ["challeng{e,es,ed,ing}"] = "chaleng{e,es,ed,ing}",
  ["change"] = "chagne",
  ...
  ["clos{e,es,ed,ing}"] = "clso{e,es,ed,ing}",
  ["cod{e,es,ed,ing}"] = "cdo{e,es,ed,ing}",
  ["coher{ent,ently}"] = "coher{ant,antly}",
  ...
  ["crucial"] = "cruical",
  ["curious{,ly}"] = "curius{,ly}",
  ["current{,ly}"] = "currnet{,ly}",
  ["database{}"] = "datbase{,s}",
  ["daughter"] = "daugther",
  ["deallocat{e,es,ed,ing,ion,ions}"] = "dealocat{e,es,ed,ing,ion,ions}",
  ["deceiv{e,es,ed,ing}"] = "decie{ve,ves,ved,ving}",
  ...
  ["demonstrat{e,es,ed,ing,ion,ions}"] = "demonstat{e,es,ed,ing,ion,ions}",
  ["dependency"] = "{depednency,dependnecy}",
  ["deprecat{e,es,ed,ing,ion,ions}"] = "depreceat{e,es,ed,ing,ion,ions}",
  ["designed"] = "desigend",
  ["desperate{,ly}"] = "desparate{,ly}",
  ...
  ["dictionar{y,ies}"] = "dictionair{y,ies}",
  ["difference{}"] = "diffrence{,s}",
  ["different"] = "{diferent,differant,diffrent}",
  ["difficult"] = "difficutl",
  ["difficul{t,ty,ties}"] = "dificul{t,ty,ties}",
  ["dilemma{}"] = "dilema{,s}",
  ...
  ["disciplin{e,es,ed,ing}"] = "disiplin{e,es,ed,ing}",
  ...
  ["dumbbell{}"] = "dumbell{,s}",
  ["duplicat{e,es,ed,ing}"] = "duplciat{e,es,ed,ing}",
  ["during"] = "duirng",
  ["dynamic"] = "dyanmic",
  ["d{escription}{}"] = "{desciption,descripton}{,s}",
  ["each"] = "eahc",
  ["ecclesiastical{,ly}"] = "eclesiastical{,ly}",
  ["ecstasy"] = "ecstacy",
  ["effect"] = "effcet",
  ["efficient"] = "efficent",
  ["eighth"] = "eigth",
  ...
  ["help"] = "hepl",
  ["helpful"] = "helpfull",
  ["hierarch{y,ies,ical,ically}"] = "heirarch{y,ies,ical,ically}",
  ["history"] = "histroy",
  ["however"] = "howveer",
  ["hygiene"] = "hygeine",
  ["hypocris{y,ies}"] = "hipocris{y,ies}",
  ...
  ["language"] = "langauge",
  ["latenc{y,ies}"] = "latanc{y,ies}",
  ["later"] = "laetr",
  ["leave"] = "levae",
  ["leisure"] = "liesure",
  ["length"] = "lenght",
  ["lethal{,ly}"] = "leathal{,ly}",
  ["liaison"] = "liason",
  ["library"] = "lib{ary,ray}",
  ["license"] = "lisence",
  ["like"] = "liek",
  ...
  ["other"] = "otehr",
  ["overrid{e,es,ing}"] = "overid{e,es,ing}",
  ["package{}"] = "pakcage{,s,d}",
  ["parallel"] = "paralell",
  ["parameter"] = "paramater",
  ...
  ["propagat{e,es,ed,ing,ion,ions}"] = "propogat{e,es,ed,ing,ion,ions}",
  ...
  ["subclass{,es}"] = "sublcass{,es}",
  ["subprocess{,es}"] = "subproccess{,es}",
